...
export const metadata: Metadata = {
  ...
  description:
    "Contact CrestMAX Sales Team on +91 70878 66759 or WhatsApp. Request a wholesale spare parts quote. Email info@crestmax.in. B2B export from India to Africa.",
...
export default function ContactPage() {
  return (
    <>
      ...
      <section style={{ padding: "72px 24px", background: "var(--cm-navy)" }}>
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            {/* Sales Team — primary contact */}
            <div style={{ background: "rgba(201,168,76,0.08)", border: "1.5px solid var(--cm-gold)", borderRadius: "2px", padding: "20px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
              <div>
                <p style={{ fontFamily: "IBM Plex Mono, monospace", fontSize: "11px", letterSpacing: "3px", color: "var(--cm-gold)", textTransform: "uppercase", marginBottom: "4px" }}>Sales Team</p>
                <a href="tel:+917087866759" style={{ fontFamily: "Rajdhani, sans-serif", fontWeight: 700, fontSize: "22px", letterSpacing: "1px", color: "#FFFFFF", textDecoration: "none" }}>
                  +91 70878 66759
                </a>
              </div>
              <a href="https://wa.me/917087866759" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: "8px", background: "#25D366", color: "white", fontFamily: "Rajdhani, sans-serif", fontWeight: 700, fontSize: "13px", letterSpacing: "2px", textTransform: "uppercase", padding: "10px 18px", borderRadius: "2px", textDecoration: "none" }}>
      ...
      <section id="agent" style={{ padding: "64px 24px", background: "var(--cm-navy-mid)", borderTop: "1px solid var(--cm-gold-border)" }}>
