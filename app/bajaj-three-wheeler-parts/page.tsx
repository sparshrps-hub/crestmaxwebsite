...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Are your Bajaj RE parts genuine or Chinese copies?", acceptedAnswer: { "@type": "Answer", text: "All parts are sourced from OEM-approved manufacturers in Ludhiana, India — the same supply chain that feeds Bajaj Auto's authorised service network. We do not supply Chinese-manufactured Bajaj RE copies, which are known to fail early in African road conditions." } },
  ],
};
