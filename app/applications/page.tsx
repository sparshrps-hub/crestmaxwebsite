...
export const metadata: Metadata = {
  title: "Applications & Compatibility | Crestmax Pvt Ltd",
  description: "Spare parts for Bajaj Boxer, TVS HLX, CT100, Bajaj RE/Keke Napep and TVS King — built for Africa's most popular vehicles.",
};

const twoWheelers = [
  { slug: "bajaj-boxer", model: "Bajaj Boxer", brand: "Bajaj", prevalence: "Dominant in Nigeria, Ghana, Uganda. High aftermarket demand.", categories: ["Engine & Drivetrain", "Clutch & Transmission", "Brakes & Suspension", "Electrical & Ignition", "Filters & Fuel", "Drive & Wheels"] },
  { slug: "tvs-hlx", model: "TVS HLX", brand: "TVS", prevalence: "Popular across East Africa — Kenya, Tanzania, Ethiopia.", categories: ["Engine & Drivetrain", "Clutch & Transmission", "Brakes & Suspension", "Electrical & Ignition", "Filters & Fuel", "Controls & Cables"] },
  { slug: "ct100", model: "CT100 Compatible", brand: "Honda / TVS", prevalence: "Regional favourite in West Africa — Nigeria, Ghana, Francophone Africa.", categories: ["Filters & Fuel", "Electrical & Ignition", "Brakes & Suspension", "Engine & Drivetrain", "Lights & Indicators", "Body & Rubber"] },
];

const threeWheelers = [
  { slug: "bajaj-re", model: "Bajaj RE / Keke Napep", brand: "Bajaj", prevalence: "Backbone of urban transport in Nigeria, Kenya, Ethiopia.", categories: ["Drivetrain & Propeller", "Differential & Rear Axle", "Engine & Transmission", "Clutch & Brakes", "Suspension", "Bearings & Seals"] },
  { slug: "tvs-king", model: "TVS King", brand: "TVS", prevalence: "Dominant 3-wheeler in Uganda, Tanzania, Rwanda, East Africa.", categories: ["Drivetrain", "Brakes", "Engine", "Clutch", "Filters & Fuel", "Bearings & Seals"] },
  { slug: "bajaj-re", model: "Tuk Tuk (Generic)", brand: "Multi-brand", prevalence: "Widely used across Central & West Africa. Most Bajaj RE parts are cross-compatible.", categories: ["Drivetrain & Propeller", "Engine & Transmission", "Clutch & Brakes", "Filters & Fuel"] },
];
  ...
  return (
    <div className="card-glow" style={{ background: "var(--cm-navy-mid)", border: "1px solid var(--cm-gold-border)", borderRadius: "2px", padding: "32px" }}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", marginBottom: "24px" }}>
        {categories.map((c) => (
          <span key={c} style={{ fontFamily: "IBM Plex Mono, monospace", fontSize: "10px", letterSpacing: "1px", color: "rgba(255,255,255,0.5)", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", padding: "4px 10px", borderRadius: "2px", textTransform: "uppercase" }}>
            {c}
          </span>
        ))}
      </div>
    ...
    <>
      <section style={{ background: "var(--cm-navy-deep)", paddingTop: "140px", paddingBottom: "64px", textAlign: "center", borderBottom: "1px solid var(--cm-gold-border)" }}>
        <div style={{ maxWidth: "800px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <h1 style={{ fontFamily: "Rajdhani, sans-serif", fontWeight: 700, fontSize: "clamp(32px, 6vw, 60px)", letterSpacing: "4px", lineHeight: "0.95", color: "#FFFFFF", textTransform: "uppercase", margin: "0 0 20px" }}>
          ...
          <p style={{ fontFamily: "Nunito Sans, sans-serif", fontWeight: 300, fontSize: "16px", color: "rgba(255,255,255,0.55)", lineHeight: "1.75" }}>
            Our catalogue is curated specifically for the most popular 2-wheelers and 3-wheelers across African markets.
          </p>
        </div>
      </section>
